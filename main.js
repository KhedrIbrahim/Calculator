...
darkIcon.onclick = function(){
    ...
    darkIcon.classList.toggle("icon-dark");
    btnDar.classList.toggle("active-dark");
    ...
    // To Change Color of All Btn 
    // for(let i=0; i<btnClick.length; i++){
    //     btnClick[i].classList.toggle("btn-mode");
    // }
    //clearBtn.classList.toggle("clear-equal-moode")
